...
namespace PiggyBank
{
    public partial class FixedPiggy : Form
    {
        ...
        private static void ShakeMetot(FixedPiggy form)
        {
        ...
        private void Updated()
        {
            label2.Text = "Total Volume:    " + string.Format("{0:0}", PBV.MoneysTotalVolume()) + "  mm3";
             label3.Text = "total:" + string.Format("{0:F2}", PBV.MoneysTotal());

        }

        

        private void FixedPiggy_Load_1(object sender, EventArgs e)
        {
            ...
            label3.Text = "Total Money: " + PBV.Crash();
        ...
        private void btnCrash_Click(object sender, EventArgs e)
        {
            ...
            te.totalmmm = label3.Text;
            te.Show();
            this.Hide();
        }

        private void btnShake_Click_1(object sender, EventArgs e)
        {
